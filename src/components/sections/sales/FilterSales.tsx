...
const FilterSales = ({ job }: any) => {
    ...
    return (
        <div className={`overlay__modal_filter_searches ${modal == 'modal__filter_searches' ? 'active' : ''}`}>
            <div className={`popup__modal_filter_searches ${modal == 'modal__filter_searches' ? 'active' : ''}`}>
                ...
                <div className='modal_filter_searches'>
                    <div className='nav__main__searches'>
                        <p className='item'>Trabajos</p>
                        <p className='item'>Casas</p>
                        <p className='item'>Articulos</p>
                    </div>
